...
#### Figure 2 — `figures/prediction_and_groundtruth.pdf`
...
#### Figure 3 — `figures/cupid_results.pdf`
...
- Figure 4, `output/02_streptomyces_cupid/part9_recall_at_k_prior` — the biological-prior
  experiment (Appendix `app:additionalresults`)
- Figure 5, `output/02_streptomyces_cupid/part11_ablation_recall_at_k` — robustness of the
  ...
  from `part11_ablation_summary.csv` in the same folder.

Only dataset 1 appears in the current version of the paper. Notebooks 04 to 07 and their
outputs are not cited by it.
